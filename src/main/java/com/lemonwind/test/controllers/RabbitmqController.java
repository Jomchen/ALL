...
import com.lemonwind.test.config.rabbitmq.directory.DirectoryService;
import com.lemonwind.test.config.rabbitmq.exchange.FanoutService;
import com.lemonwind.test.config.rabbitmq.moresingle.MoreSingleService;
import com.lemonwind.test.config.rabbitmq.single.SingleService;
import com.lemonwind.test.config.rabbitmq.topics.TopicService;
